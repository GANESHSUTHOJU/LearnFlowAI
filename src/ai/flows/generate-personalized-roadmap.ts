...
After the roadmap, generate a quiz with exactly 25 multiple-choice questions that covers all the topics in the roadmap. For each question, you MUST provide:
1. The question text.
