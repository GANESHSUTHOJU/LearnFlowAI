...
const GeneratePersonalizedRoadmapOutputSchema = z.object({
  ...
  quiz: z.array(QuizQuestionSchema).describe('A comprehensive quiz with up to 25 multiple-choice questions related to the roadmap.'),
});
...
After the roadmap, generate a quiz with up to 25 multiple-choice questions that covers all the topics in the roadmap. For each question, you MUST provide:
1. The question text.
